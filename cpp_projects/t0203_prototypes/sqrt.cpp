...
int main()
{
    ...
    double side;
    // TODO: Calculate the side length of the square using the sqrt function.
    // Replace the following line with code that computes the square root of 'cover'
    // and stores it in a variable named 'side'.
